...
<div class="bg-purple-600 min-h w-full rounded-b-3xl flex flex-col">
    <div class="flex justify-around p-4">
        <span  class="bg-green-500 rounded-xl flex justify-center items-center max-md:w-[20%]  w-[20%] p-1 max-md:h-5 h-7 "><p class="text-lg font-medium ">${jeux.category}</p></span>
